...
- Google OIDC, session and Account infrastructure: `apps/server/src/google-oidc*`, `apps/server/src/onboarding-api*`, `apps/server/src/account-infrastructure*`, `apps/desktop/src/account-infrastructure`.
